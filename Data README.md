# Prognosis analysis
Input file: "CruchagaLab_CSF_SOMAscan7k_Protein_matrix_postQC_20230620-2.csv" obtained from the ADNI database.
...
CSV includes RID, time_followup, status, age, sex, and signature values. Values were acquired based on ROC_curve_cross_validation.R using CU vs A+T+ MCI (n = 350), and A+T+ MCI vs A+T+ dementia (n = 399) datasets 
